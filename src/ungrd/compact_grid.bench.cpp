...
BENCHMARK_TEMPLATE(
    BMT_Grid_AllMoveOneUpdate_DenseCells, s32_e32_compact_grid<3>)
    ->Ranges({EXTENT_RANGE, EXTENT_RANGE, EXTENT_RANGE, DENSE_ENTRY_RANGE});

BENCHMARK_TEMPLATE(
    BMT_Grid_AllMoveOneUpdate_RandomCells, s32_e32_compact_grid<3>)
    ->Ranges({EXTENT_RANGE, EXTENT_RANGE, EXTENT_RANGE, RANDOM_ENTRY_RANGE});

// SomeMoveOneUpdate

BENCHMARK_TEMPLATE(
    BMT_Grid_SomeMoveOneUpdate_RandomCells, s32_e32_compact_grid<3>)
    ->Ranges(
